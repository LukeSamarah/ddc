            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12">
              ...
              <div aria-live="polite" aria-atomic="true">
                {submitStatus === 'success' && (
                  <div className="mb-6 p-4 bg-success-muted border border-success/20 rounded-xl" role="status">
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-success mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                {submitStatus === 'error' && (
                  <div className="mb-6 p-4 bg-error-muted border border-error/20 rounded-xl" role="alert">
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-error mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
